...
export type OutputTimezoneType = {
  ...
  payload?: Maybe<Array<Maybe<TimezoneType>>>;
...
export type QueryResolvers<ContextType = ResourcesContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
...
export type OutputTimezoneTypeResolvers<ContextType = ResourcesContext, ParentType extends ResolversParentTypes['OutputTimezoneType'] = ResolversParentTypes['OutputTimezoneType']> = {
  payload?: Resolver<Maybe<Array<Maybe<ResolversTypes['TimezoneType']>>>, ParentType, ContextType>;
  status?: Resolver<Maybe<ResolversTypes['StatusType']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TimezoneTypeResolvers<ContextType = ResourcesContext, ParentType extends ResolversParentTypes['TimezoneType'] = ResolversParentTypes['TimezoneType']> = {
...
export type MetaTypeResolvers<ContextType = ResourcesContext, ParentType extends ResolversParentTypes['MetaType'] = ResolversParentTypes['MetaType']> = {
...
export type AttributeResolvers<ContextType = ResourcesContext, ParentType extends ResolversParentTypes['Attribute'] = ResolversParentTypes['Attribute']> = {
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  value?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StatusTypeResolvers<ContextType = ResourcesContext, ParentType extends ResolversParentTypes['StatusType'] = ResolversParentTypes['StatusType']> = {
...
export type SortEnumTypeResolvers = { ASC: 1, DESC: 2 };

export type Resolvers<ContextType = ResourcesContext> = {
 ...
 */
export type IResolvers<ContextType = ResourcesContext> = Resolvers<ContextType>;
