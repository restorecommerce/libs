...
export type RestoreCommerceFeature<TState extends object = {}, TContent extends object = {}> = {
  (facade: Facade<RestoreCommerceFeature<TState, TContent>>): void;
};

export type RestoreCommerceFeatureWithDeps<TState extends object, TContent extends object, TRequiredFeature extends RestoreCommerceFeature> = {
  (facade: Facade<MergeFeatures<RestoreCommerceFeature<TState, TContent>, TRequiredFeature>>): void;
};
...
export class FacadImpl<TFeature extends RestoreCommerceFeature = any> implements Facade<TFeature> {
  ...
  feature<TNewFeature extends RestoreCommerceFeature<ExtractFacadeState<TFeature>, ExtractFacadeContext<TFeature>>>(feature: TNewFeature): Facade<RestoreCommerceFeature<ExtractFacadeState<TFeature> & ExtractFacadeState<TNewFeature>, ExtractFacadeContext<TFeature> & ExtractFacadeContext<TNewFeature>>> {
    feature(this as any);
    return this as any;
  }
