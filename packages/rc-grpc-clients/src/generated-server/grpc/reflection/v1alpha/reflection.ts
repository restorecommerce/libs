...
export interface ServerReflectionRequest {
  ...
  file_by_filename: string | undefined;
  /**
   * / Find the proto file that declares the given fully-qualified symbol name.
   * / This field should be a fully-qualified symbol name
   * / (e.g. <package>.<service>[.<method>] or <package>.<type>).
   */
  file_containing_symbol: string | undefined;
  /**
   * / Find the proto file which defines an extension extending the given
   * / message type with the given field number.
   */
  file_containing_extension?: ExtensionRequest | undefined;
  /**
   ...
   * / <package>.<type>
   */
  all_extension_numbers_of_type: string | undefined;
  /**
...
export interface ServerReflectionResponse {
   ...
   */
  file_descriptor_response?: FileDescriptorResponse | undefined;
  /** / This message is used to answer all_extension_numbers_of_type requst. */
  all_extension_numbers_response?: ExtensionNumberResponse | undefined;
  /** / This message is used to answer list_services request. */
  list_services_response?: ListServiceResponse | undefined;
...
export const ServerReflectionRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.file_containing_extension = ExtensionRequest.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): ServerReflectionRequest {
    return {
      ...
      file_by_filename: isSet(object.file_by_filename)
        ? String(object.file_by_filename)
        : undefined,
      file_containing_symbol: isSet(object.file_containing_symbol)
        ? String(object.file_containing_symbol)
        : undefined,
      ...
      all_extension_numbers_of_type: isSet(object.all_extension_numbers_of_type)
        ...
        : undefined,
      list_services: isSet(object.list_services)
        ? String(object.list_services)
        : undefined,
    };
  },
  ...
  toJSON(message: ServerReflectionRequest): unknown {
    ...
    message.file_by_filename !== undefined &&
      (obj.file_by_filename = message.file_by_filename);
    message.file_containing_symbol !== undefined &&
      (obj.file_containing_symbol = message.file_containing_symbol);
    ...
    message.all_extension_numbers_of_type !== undefined &&
      (obj.all_extension_numbers_of_type =
        message.all_extension_numbers_of_type);
    message.list_services !== undefined &&
      (obj.list_services = message.list_services);
    return obj;
  },

  fromPartial(
    object: DeepPartial<ServerReflectionRequest>
  ): ServerReflectionRequest {
    const message = createBaseServerReflectionRequest();
    ...
    message.file_containing_extension =
      object.file_containing_extension !== undefined &&
      object.file_containing_extension !== null
        ? ExtensionRequest.fromPartial(object.file_containing_extension)
        : undefined;
    message.all_extension_numbers_of_type =
      object.all_extension_numbers_of_type ?? undefined;
...
export const ExtensionRequest = {
  ...
  fromJSON(object: any): ExtensionRequest {
    return {
      containing_type: isSet(object.containing_type)
        ? String(object.containing_type)
        : "",
      extension_number: isSet(object.extension_number)
        ? Number(object.extension_number)
        : 0,
    };
  },
  ...
  toJSON(message: ExtensionRequest): unknown {
    const obj: any = {};
    message.containing_type !== undefined &&
      (obj.containing_type = message.containing_type);
    message.extension_number !== undefined &&
      (obj.extension_number = Math.round(message.extension_number));
    return obj;
  },
...
export const ServerReflectionResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.original_request = ServerReflectionRequest.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.file_descriptor_response = FileDescriptorResponse.decode(
            reader,
            reader.uint32()
          );
          break;
        case 5:
          message.all_extension_numbers_response =
            ExtensionNumberResponse.decode(reader, reader.uint32());
          break;
        case 6:
          message.list_services_response = ListServiceResponse.decode(
            reader,
            reader.uint32()
          );
          break;
        case 7:
          message.error_response = ErrorResponse.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): ServerReflectionResponse {
    return {
      ...
      file_descriptor_response: isSet(object.file_descriptor_response)
        ...
        : undefined,
      all_extension_numbers_response: isSet(
        object.all_extension_numbers_response
      )
        ? ExtensionNumberResponse.fromJSON(
            object.all_extension_numbers_response
          )
        : undefined,
      list_services_response: isSet(object.list_services_response)
        ...
        : undefined,
      error_response: isSet(object.error_response)
        ? ErrorResponse.fromJSON(object.error_response)
        : undefined,
    };
  },
  ...
  toJSON(message: ServerReflectionResponse): unknown {
    ...
    message.original_request !== undefined &&
      (obj.original_request = message.original_request
        ? ServerReflectionRequest.toJSON(message.original_request)
        : undefined);
    message.file_descriptor_response !== undefined &&
      (obj.file_descriptor_response = message.file_descriptor_response
        ? FileDescriptorResponse.toJSON(message.file_descriptor_response)
        : undefined);
    message.all_extension_numbers_response !== undefined &&
      (obj.all_extension_numbers_response =
        message.all_extension_numbers_response
          ? ExtensionNumberResponse.toJSON(
              message.all_extension_numbers_response
            )
          : undefined);
    message.list_services_response !== undefined &&
      (obj.list_services_response = message.list_services_response
        ? ListServiceResponse.toJSON(message.list_services_response)
        : undefined);
    message.error_response !== undefined &&
      (obj.error_response = message.error_response
        ? ErrorResponse.toJSON(message.error_response)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<ServerReflectionResponse>
  ): ServerReflectionResponse {
    const message = createBaseServerReflectionResponse();
    message.valid_host = object.valid_host ?? "";
    message.original_request =
      object.original_request !== undefined && object.original_request !== null
        ? ServerReflectionRequest.fromPartial(object.original_request)
        : undefined;
    message.file_descriptor_response =
      object.file_descriptor_response !== undefined &&
      object.file_descriptor_response !== null
        ? FileDescriptorResponse.fromPartial(object.file_descriptor_response)
        : undefined;
    message.all_extension_numbers_response =
      object.all_extension_numbers_response !== undefined &&
      object.all_extension_numbers_response !== null
        ? ExtensionNumberResponse.fromPartial(
            object.all_extension_numbers_response
          )
        : undefined;
    message.list_services_response =
      object.list_services_response !== undefined &&
      object.list_services_response !== null
        ? ListServiceResponse.fromPartial(object.list_services_response)
        : undefined;
    message.error_response =
      object.error_response !== undefined && object.error_response !== null
...
export const FileDescriptorResponse = {
  ...
  fromJSON(object: any): FileDescriptorResponse {
    return {
      file_descriptor_proto: Array.isArray(object?.file_descriptor_proto)
        ? object.file_descriptor_proto.map((e: any) =>
  ...
  fromPartial(
    object: DeepPartial<FileDescriptorResponse>
  ): FileDescriptorResponse {
    const message = createBaseFileDescriptorResponse();
    message.file_descriptor_proto =
      object.file_descriptor_proto?.map((e) => e) || [];
    return message;
  },
};
...
export const ExtensionNumberResponse = {
  ...
  fromJSON(object: any): ExtensionNumberResponse {
    return {
      base_type_name: isSet(object.base_type_name)
        ? String(object.base_type_name)
        : "",
  ...
  toJSON(message: ExtensionNumberResponse): unknown {
    const obj: any = {};
    message.base_type_name !== undefined &&
      (obj.base_type_name = message.base_type_name);
  ...
  fromPartial(
    object: DeepPartial<ExtensionNumberResponse>
  ): ExtensionNumberResponse {
    const message = createBaseExtensionNumberResponse();
...
export const ListServiceResponse = {
  ...
  toJSON(message: ListServiceResponse): unknown {
    ...
    if (message.service) {
      obj.service = message.service.map((e) =>
        e ? ServiceResponse.toJSON(e) : undefined
      );
    } else {
      obj.service = [];
    }
  ...
  fromPartial(object: DeepPartial<ListServiceResponse>): ListServiceResponse {
    const message = createBaseListServiceResponse();
    message.service =
      object.service?.map((e) => ServiceResponse.fromPartial(e)) || [];
    return message;
  },
};
