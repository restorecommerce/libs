...
export const AuthenticationLog = {
  ...
  fromJSON(object: any): AuthenticationLog {
    return {
      ...
      ipv4_address: isSet(object.ipv4_address)
        ? String(object.ipv4_address)
        : "",
      ipv6_address: isSet(object.ipv6_address)
        ? String(object.ipv6_address)
        : "",
      operating_system: isSet(object.operating_system)
        ? String(object.operating_system)
        : "",
