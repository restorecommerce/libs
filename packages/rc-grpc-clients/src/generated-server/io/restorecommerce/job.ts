...
function createBaseData(): Data {
  return { payload: undefined, meta: undefined, subject_id: undefined };
}
...
function createBaseScheduledJob(): ScheduledJob {
  return { id: undefined, type: undefined, data: undefined, schedule_type: undefined };
}
...
export const ScheduledJob = {
  ...
  fromJSON(object: any): ScheduledJob {
    return {
      ...
      type: isSet(object.type) ? String(object.type) : undefined,
      data: isSet(object.data) ? Data.fromJSON(object.data) : undefined,
      schedule_type: isSet(object.schedule_type) ? String(object.schedule_type) : undefined,
    };
  },
...
function createBaseJobDone(): JobDone {
  return { id: undefined, schedule_type: undefined, delete_scheduled: undefined, type: undefined, result: undefined };
}
...
export const JobDone = {
  encode(message: JobDone, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.delete_scheduled !== undefined) {
  ...
  fromJSON(object: any): JobDone {
    return {
      id: isSet(object.id) ? String(object.id) : undefined,
      schedule_type: isSet(object.schedule_type) ? String(object.schedule_type) : undefined,
      delete_scheduled: isSet(object.delete_scheduled) ? Boolean(object.delete_scheduled) : undefined,
      type: isSet(object.type) ? String(object.type) : undefined,
  ...
  fromPartial(object: DeepPartial<JobDone>): JobDone {
    ...
    message.id = object.id ?? undefined;
    message.schedule_type = object.schedule_type ?? undefined;
    message.delete_scheduled = object.delete_scheduled ?? undefined;
    message.type = object.type ?? undefined;
...
function createBaseJobFailed(): JobFailed {
  return { id: undefined, error: undefined, schedule_type: undefined, type: undefined };
}
