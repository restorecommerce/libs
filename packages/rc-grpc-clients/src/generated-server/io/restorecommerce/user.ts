...
export const RegisterRequest = {
  ...
  fromJSON(object: any): RegisterRequest {
    return {
      ...
      default_scope: isSet(object.default_scope)
        ? String(object.default_scope)
        : "",
      user_type: isSet(object.user_type)
        ? userTypeFromJSON(object.user_type)
        : UserType.ORG_USER,
      captcha_code: isSet(object.captcha_code)
        ? String(object.captcha_code)
        : "",
    };
  },
...
export const ActivateRequest = {
  ...
  fromJSON(object: any): ActivateRequest {
    return {
      identifier: isSet(object.identifier) ? String(object.identifier) : "",
      activation_code: isSet(object.activation_code)
        ? String(object.activation_code)
        : "",
      subject: isSet(object.subject)
        ? Subject.fromJSON(object.subject)
        : undefined,
...
function createBaseChangePasswordRequest(): ChangePasswordRequest {
  return { identifier: "", password: "", new_password: "", subject: undefined };
}
...
export const PasswordChanged = {
  ...
  fromJSON(object: any): PasswordChanged {
    return {
      id: isSet(object.id) ? String(object.id) : "",
      password_hash: isSet(object.password_hash)
        ? String(object.password_hash)
        : "",
    };
  },
...
export const User = {
  ...
  fromJSON(object: any): User {
    return {
      ...
      invited_by_user_name: isSet(object.invited_by_user_name)
        ? String(object.invited_by_user_name)
        : "",
