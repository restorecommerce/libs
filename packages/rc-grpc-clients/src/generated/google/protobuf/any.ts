...
export const metaAny: { [key in keyof Required<Any>]: MetaBase | string } = {
  typeUrl: {kind:'builtin', type:'string', original:'string'} as MetaPrimitive,
  value: {kind:'builtin', type:'Buffer', original:'bytes'} as MetaPrimitive,
}
