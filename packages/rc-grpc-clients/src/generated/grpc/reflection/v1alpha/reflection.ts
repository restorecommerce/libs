...
export const ServerReflectionRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.fileContainingExtension = ExtensionRequest.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): ServerReflectionRequest {
    return {
      ...
      fileByFilename: isSet(object.fileByFilename)
        ? String(object.fileByFilename)
        : undefined,
      fileContainingSymbol: isSet(object.fileContainingSymbol)
        ? String(object.fileContainingSymbol)
        : undefined,
      ...
      allExtensionNumbersOfType: isSet(object.allExtensionNumbersOfType)
        ...
        : undefined,
      listServices: isSet(object.listServices)
        ? String(object.listServices)
        : undefined,
    };
  },
  ...
  toJSON(message: ServerReflectionRequest): unknown {
    ...
    message.fileContainingExtension !== undefined &&
      (obj.fileContainingExtension = message.fileContainingExtension
  ...
  fromPartial(
    ...
    message.fileContainingExtension =
      object.fileContainingExtension !== undefined &&
      object.fileContainingExtension !== null
        ? ExtensionRequest.fromPartial(object.fileContainingExtension)
        : undefined;
    message.allExtensionNumbersOfType =
      object.allExtensionNumbersOfType ?? undefined;
...
export const ExtensionRequest = {
  ...
  fromJSON(object: any): ExtensionRequest {
    return {
      containingType: isSet(object.containingType)
        ? String(object.containingType)
        : "",
      extensionNumber: isSet(object.extensionNumber)
        ? Number(object.extensionNumber)
        : 0,
    };
  },
  ...
  toJSON(message: ExtensionRequest): unknown {
    const obj: any = {};
    message.containingType !== undefined &&
      (obj.containingType = message.containingType);
    message.extensionNumber !== undefined &&
...
export const ServerReflectionResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.originalRequest = ServerReflectionRequest.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.fileDescriptorResponse = FileDescriptorResponse.decode(
            reader,
            reader.uint32()
          );
          break;
        case 5:
          ...
          break;
        case 6:
          message.listServicesResponse = ListServiceResponse.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: ServerReflectionResponse): unknown {
    ...
    message.originalRequest !== undefined &&
      (obj.originalRequest = message.originalRequest
        ? ServerReflectionRequest.toJSON(message.originalRequest)
        : undefined);
    message.fileDescriptorResponse !== undefined &&
      (obj.fileDescriptorResponse = message.fileDescriptorResponse
    ...
    message.listServicesResponse !== undefined &&
      (obj.listServicesResponse = message.listServicesResponse
...
export const FileDescriptorResponse = {
  ...
  fromJSON(object: any): FileDescriptorResponse {
    return {
      fileDescriptorProto: Array.isArray(object?.fileDescriptorProto)
        ? object.fileDescriptorProto.map((e: any) =>
  ...
  fromPartial(
    ...
    message.fileDescriptorProto =
      object.fileDescriptorProto?.map((e) => e) || [];
    return message;
  },
};
...
export const ExtensionNumberResponse = {
  ...
  fromJSON(object: any): ExtensionNumberResponse {
    return {
      baseTypeName: isSet(object.baseTypeName)
        ? String(object.baseTypeName)
        : "",
      extensionNumber: Array.isArray(object?.extensionNumber)
        ? object.extensionNumber.map((e: any) => Number(e))
        : [],
    };
  },
  ...
  toJSON(message: ExtensionNumberResponse): unknown {
    const obj: any = {};
    message.baseTypeName !== undefined &&
