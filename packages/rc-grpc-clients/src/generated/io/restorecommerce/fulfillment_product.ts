...
import { FulfillmentAddress, Item, Parcel, protoMetadata as protoMetadata7 } from "./fulfillment";
...
function createBaseQuery(): Query {
  return { sender: undefined, receiver: undefined, goods: [], preferences: undefined, referenceId: "" };
}

export const Query = {
  encode(message: Query, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sender !== undefined) {
      FulfillmentAddress.encode(message.sender, writer.uint32(10).fork()).ldelim();
    }
    if (message.receiver !== undefined) {
      FulfillmentAddress.encode(message.receiver, writer.uint32(18).fork()).ldelim();
    }
...
function createBasePackingSolution(): PackingSolution {
  return { referenceId: "", price: 0, compactness: 0, homogeneity: 0, score: 0, parcels: [] };
}
