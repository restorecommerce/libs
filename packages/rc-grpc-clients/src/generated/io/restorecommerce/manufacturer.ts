...
export const ManufacturerList = {
  encode(message: ManufacturerList, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const ManufacturerListResponse = {
  encode(message: ManufacturerListResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.items) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ManufacturerListResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.items.push(ManufacturerResponse.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 16) {
            break;
  ...
  fromJSON(object: any): ManufacturerListResponse {
    return {
      items: Array.isArray(object?.items) ? object.items.map((e: any) => ManufacturerResponse.fromJSON(e)) : [],
  ...
  toJSON(message: ManufacturerListResponse): unknown {
    const obj: any = {};
    if (message.items) {
      obj.items = message.items.map((e) => e ? ManufacturerResponse.toJSON(e) : undefined);
    } else {
      obj.items = [];
    }
    message.totalCount !== undefined && (obj.totalCount = Math.round(message.totalCount));
...
export const ManufacturerResponse = {
  encode(message: ManufacturerResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ManufacturerResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: ManufacturerResponse): unknown {
    const obj: any = {};
    message.payload !== undefined && (obj.payload = message.payload ? Manufacturer.toJSON(message.payload) : undefined);
