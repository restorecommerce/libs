...
import { UserResponse, protoMetadata as protoMetadata2 } from "./user";
import { Tokens, Subject, protoMetadata as protoMetadata1 } from "./auth";
import { Status, protoMetadata as protoMetadata3 } from "./status";
...
export interface ServiceServiceImplementation<CallContextExt = {}> {
  ...
  ): Promise<DeepPartial<ServicesResponse>>;
  generateLinks(
    request: Empty,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<GenerateLinksResponse>>;
  exchangeCode(
  ...
  getToken(
    ...
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<GetTokenResponse>>;
}
...
export interface ServiceClient<CallOptionsExt = {}> {
  ...
  getToken(
    request: DeepPartial<GetTokenRequest>,
    options?: CallOptions & CallOptionsExt
