...
function createBaseCopyResponseList(): CopyResponseList {
  return { responses: [], operationStatus: undefined };
}
...
export const Options = {
  ...
  fromJSON(object: any): Options {
    return {
      ...
      contentLanguage: isSet(object.contentLanguage) ? String(object.contentLanguage) : undefined,
...
function createBaseObjectResponse(): ObjectResponse {
  return { response: undefined, operationStatus: undefined };
}
...
function createBaseObjectData(): ObjectData {
  return { objectName: "", url: "", meta: undefined };
}
...
function createBaseListRequest(): ListRequest {
  return { bucket: "", filters: undefined, subject: undefined, maxKeys: undefined, prefix: undefined };
}
...
export const ListRequest = {
  ...
  fromJSON(object: any): ListRequest {
    return {
      ...
      subject: isSet(object.subject) ? Subject.fromJSON(object.subject) : undefined,
      maxKeys: isSet(object.maxKeys) ? Number(object.maxKeys) : undefined,
