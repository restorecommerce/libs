...
import { Effect, effectFromJSON, effectToJSON, protoMetadata as protoMetadata5, Target } from "./rule";
...
function createBasePolicySetRQ(): PolicySetRQ {
  return { id: "", target: undefined, combiningAlgorithm: "", policies: [], effect: 0 };
}
