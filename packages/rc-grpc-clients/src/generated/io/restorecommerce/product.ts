...
export const IndividualProduct = {
  ...
  fromJSON(object: any): IndividualProduct {
    return {
      ...
      originCountryId: isSet(object.originCountryId) ? String(object.originCountryId) : undefined,
  ...
  toJSON(message: IndividualProduct): unknown {
    ...
    message.originCountryId !== undefined && (obj.originCountryId = message.originCountryId);
