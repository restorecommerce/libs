...
function createBaseProperty(): Property {
  return { id: undefined, value: undefined, unitCode: undefined };
}
...
export const Property = {
  ...
  fromJSON(object: any): Property {
    return {
      ...
      unitCode: isSet(object.unitCode) ? String(object.unitCode) : undefined,
    };
  },
  ...
  toJSON(message: Property): unknown {
    ...
    message.unitCode !== undefined && (obj.unitCode = message.unitCode);
    return obj;
  },
